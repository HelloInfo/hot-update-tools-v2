...
let self = module.exports = {
    cfgData: {
        ...
        genVersionDebug: null,//debug manifest版本
    },
    ...
    saveConfig(data) {
        ...
        this.cfgData.serverRootDirTest = data.serverRootDirTest;
        ...
        this.cfgData.versionDebug = data.versionDebug;
        this.cfgData.serverRootDirDebug = data.serverRootDirDebug;
    ...
    updateGenTime(time, version, buildType) {
        this.cfgData.genTime = time;
        if (buildType == "release") {
            this.cfgData.genVersion = version;
        } else if (buildType == "debug") {
            this.cfgData.genVersionDebug = version;
        }
        this._save();
    },
    ...
    // manifest文件包地址
    getMainFestDir(buildType) {
        let userDataPath = electron.remote.app.getPath('userData');
        path.join(userDataPath, "hot-update-tools-manifestOutPut");
        return path.join(userDataPath + "/hot-update-tools-manifestOutPut/", buildType);
